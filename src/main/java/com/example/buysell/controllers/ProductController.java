...
public class ProductController {
    ...
    public String productMessage(@PathVariable("id") Long id, @RequestParam("message") String message,
                                 @RequestParam("email") String email, @RequestParam("phoneNumber") String phoneNumber,
                                 @RequestParam("name") String name, Principal principal, Model model) {
        productService.messageToSellerProduct(id, name, phoneNumber, email, message);
        model.addAttribute("user", productService.getUserByPrincipal(principal));
